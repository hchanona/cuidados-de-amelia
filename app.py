...
media_movil = calorias_por_dia.rolling(window=1, min_periods=7).mean()
...
extraccion_media_movil = extraccion_por_dia.rolling(window=1, min_periods=7).mean()
...
porcentaje_materna_media_movil = porcentaje_materna_por_dia.rolling(window=1, min_periods=7).mean()
